...
OPENAI_API_KEY="${DIANE_OPENAI_API_KEY}}" SUBJECT_LINE=$(llm "$SUBJECT_LINE_INPUT" --model gpt-4o --no-stream --system "Please provide a very short, single sentence summary of no more than 12 words")
echo "$SUBJECT_LINE"
